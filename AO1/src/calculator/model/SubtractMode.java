...
public class SubtractMode implements StateTransition{
    private Calculator calculator;
    private double number1;
    private String number2 = "0";
    public SubtractMode(Calculator calculator){
    ...
    public void equalsPressed() {
        ...
        this.calculator.setState(new EqualModeMinus(this.calculator));
    }

    public void decimalPressed() {
        this.calculator.setRight(Double.parseDouble(this.number2));
        this.calculator.setState(new DecimalSubtract(this.calculator));
    }
}
