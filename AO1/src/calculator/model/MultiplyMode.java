...
public class MultiplyMode implements StateTransition{
    private Calculator calculator;
    private double number1;
    private String number2 = "0";
    public MultiplyMode(Calculator calculator){
    ...
    public void equalsPressed() {
        ...
        this.calculator.setState(new EqualModeTimes(this.calculator));
    }

    public void decimalPressed() {
        this.calculator.setRight(Double.parseDouble(this.number2));
        this.calculator.setState(new DecimalTimes(this.calculator));
    }
}
